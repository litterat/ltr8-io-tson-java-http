...
class TsonSchemaHeaderTest {
    ...
    private static final String V1 = "https://schemas.example.com/2026/33/app/order-1.tn";
    private static final String V2 = "https://schemas.example.com/2026/33/app/order-2.tn";
    ...
    void aBodyWithNoMarkSupportIsStillReadableAfterTheLook() throws Exception {
        ...
        assertEquals(Optional.of("https://schemas.example.com/2026/33/app/order-1.tn"), governing.schema());
        assertEquals(document, new String(governing.body().readAllBytes(), StandardCharsets.UTF_8),
