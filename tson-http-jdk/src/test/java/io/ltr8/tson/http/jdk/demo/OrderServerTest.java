...
class OrderServerTest {
    ...
    void publishesBothSchemasAtTheirIdentityPaths() throws Exception {
        ...
        assertEquals(TsonProblemSchema.source(), get("/2026/32/ltr8/http/problem-4.tn").body());
        ...
        assertEquals(TsonProblemSchema.publishedById().get(TsonProblemSchema.ID_3),
                get("/2026/32/ltr8/http/problem-3.tn").body());
    }
}
